...
const defaultSettings: SiteSettings = {
    site_name: "DIYA'S ORGANICS",
    site_tagline: 'Ayurvedic-inspired hair care for stronger, thicker, healthier hair.',
    site_logo: '/diya.png',
    contact_email: 'diyabeauty1@yahoo.com',
    contact_phone: '0500590559',
    contact_address: 'Haatso, Accra, Ghana',
    social_facebook: '',
    social_instagram: 'https://www.instagram.com/diya_organics',
    social_twitter: 'https://x.com/DiyaOrganics',
    social_tiktok: '',
    social_snapchat: '',
    social_youtube: '',
