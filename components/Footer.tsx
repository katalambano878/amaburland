...
export default function Footer() {
  ...
  const siteLogo = getSetting('site_logo') || '/diya_white.png';
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
            ...
            <div className="lg:col-span-4 space-y-8 pr-0 lg:pr-12">
              <Link href="/" className="inline-block group transition-all duration-500 hover:opacity-80">
                <Image src="/diya_white.png" alt={siteName} width={150} height={48} className="h-12 w-auto object-contain object-left opacity-90" unoptimized />
              </Link>

              <p className="text-gray-400 font-light leading-relaxed text-[15px] max-w-sm">
                Diya Organics strives to keep you informed about every ingredient that touches your hair, so it can truly thrive and flourish.
              </p>
