          ...
          <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="h-[5.5rem] grid grid-cols-[auto_1fr_auto] items-center gap-4">
              ...
              <div className="flex items-center gap-2 sm:gap-4">
                ...
                >
                  <Image src="/diya_dark.png" alt={siteName} width={140} height={44} className="h-9 w-auto md:h-11 object-contain object-left" priority />
                </Link>
              </div>
          ...
          <div className="absolute top-0 left-0 bottom-0 w-4/5 max-w-xs bg-white shadow-xl flex flex-col animate-in slide-in-from-left duration-300">
            <div className="p-4 border-b border-gray-100 flex items-center justify-between">
              <Link href="/" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center">
                <Image src="/diya_dark.png" alt={siteName} width={120} height={38} className="h-8 w-auto object-contain object-left" />
              </Link>
              <button
                onClick={() => setIsMobileMenuOpen(false)}
