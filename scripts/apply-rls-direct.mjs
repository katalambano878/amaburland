...
const PROJECT_REF = envContent.match(/SUPABASE_PROJECT_REF=(.+)/)?.[1]?.trim() || envContent.match(/NEXT_PUBLIC_SUPABASE_URL=https:\/\/([a-zA-Z0-9]+)\.supabase\.co/)?.[1] || 'nmjhbjpswagubpfxbjse';
