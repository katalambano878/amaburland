...
const SUPABASE_URL = process.env.SUPABASE_URL || 'https://nmjhbjpswagubpfxbjse.supabase.co';
...
if (failed > 0) {
    ...
    console.log(`Go to your Supabase dashboard SQL Editor for your project ref.`);
