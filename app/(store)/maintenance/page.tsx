      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="text-gray-500 text-sm">
          ...
          <div className="flex gap-4 justify-center mt-4">
            <a href="https://www.instagram.com/Anael_cosmtics" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white border border-gray-200 rounded-full flex items-center justify-center hover:bg-gray-50 transition-colors">
              <i className="ri-instagram-line text-gray-600"></i>
            </a>
            <a href="https://www.tiktok.com/@Anael_cosmtics" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white border border-gray-200 rounded-full flex items-center justify-center hover:bg-gray-50 transition-colors">
              <i className="ri-tiktok-fill text-gray-600"></i>
            </a>
            <a href="https://www.snapchat.com/add/hira3166" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white border border-gray-200 rounded-full flex items-center justify-center hover:bg-gray-50 transition-colors">
              <i className="ri-snapchat-fill text-gray-600"></i>
            </a>
          </div>
        </div>
      </div>
