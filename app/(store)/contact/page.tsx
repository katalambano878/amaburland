...
export default function ContactPage() {
  ...
  const contactPhone = getSetting('contact_phone') || '0500590559';
                  ...
                  {contactPhone && (
                    <div className="flex items-start gap-4 text-gray-600">
                      ...
                      <div className="pt-2 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                        ...
                        <a href="https://wa.me/233500590559" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-xs font-semibold px-3 py-1 rounded-full bg-green-50 text-green-700 hover:bg-green-100 transition-colors">
