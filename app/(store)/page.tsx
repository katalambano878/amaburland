        ...
        {[
          {
            image: '/hero1.png',
            tag: 'Ayurvedic Care',
            heading: <>Nourish & <br /><span className="italic font-light text-emerald-200">Thrive</span></>,
            subtext: 'Experience our signature Ayurvedic-inspired hair formulas crafted to help your hair truly flourish and grow.',
            cta: { text: 'Discover Hair Care', href: '/shop' },
          ...
          },
          {
            ...
            heading: <>Subtle <br /><span className="italic font-light text-rose-200">Elegance</span></>,
            subtext: 'From natural wispy lashes to hydrating lip care, elevate your everyday look with our curated premium collection.',
            cta: { text: 'Shop Beauty', href: '/shop?category=beauty' },
          ...
          },
          {
            ...
            subtext: 'Treat yourself to premium beauty and wellness. Don\'t miss out on our seasonal discounts on your favorite items.',
