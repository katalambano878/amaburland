...
export default function AboutPage() {
  ...
  const siteName = getSetting('site_name') || "DIYA'S ORGANICS";
  ...
  return (
    <div className="min-h-screen bg-white">
      <PageHero
        title="More Than Just A Hair Brand"
        subtitle="Diya Organics creates Ayurvedic-inspired hair care so your hair can truly thrive and flourish."
        backgroundImage="/new5.png"
      />
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center animate-in fade-in slide-in-from-bottom-8 duration-700">
            <div className="order-2 lg:order-1">
              ...
              <div className="space-y-6 text-lg text-gray-500 leading-relaxed font-light">
                <p>
                  <strong className="font-semibold text-gray-900">{siteName}</strong> was created to answer a simple question: what happens when you truly understand what goes into your hair? Hair is like any other part of the body — it needs to be nourished, protected and treated with care and intention.
                </p>
                <p>
                  At Diya Organics, we craft Ayurvedic-inspired hair care using herbs sourced from Africa, India and the Middle East. Every formula is made to support stronger, thicker, lusher and healthier hair, with ingredients chosen not just for trends, but for results.
                </p>
                <p>
                  We believe in transparency, education and consistency. When you know what is in your products, you can make better choices for your hair — and give it the chance to truly thrive and flourish.
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <div className="group relative bg-white p-10 sm:p-14 rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.03)] hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.08)] transition-all duration-1000 overflow-hidden ring-1 ring-gray-900/5 hover:ring-gray-900/10 hover:-translate-y-1">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-500 text-[1.125rem] leading-[1.8] font-light group-hover:text-gray-600 transition-colors duration-700">
                  From growth-focused oils and butters to nourishing treatments, our goal is to give your hair what it truly needs to flourish. We focus on ingredients that strengthen from the roots, support scalp health and help you maintain a consistent routine.
                </p>
              </div>
            </div>
            ...
            <div className="group relative bg-white p-10 sm:p-14 rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.03)] hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.08)] transition-all duration-1000 overflow-hidden ring-1 ring-gray-900/5 hover:ring-gray-900/10 hover:-translate-y-1">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-500 text-[1.125rem] leading-[1.8] font-light group-hover:text-gray-600 transition-colors duration-700">
                  Whether you are just starting your healthy hair journey or looking to repair years of damage, {siteName} is here to support you with intentional formulations, clear information and consistent quality.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="relative bg-gradient-to-b from-[#FAFAFA] to-white py-24 lg:py-32 overflow-hidden border-t border-gray-100">
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20 flex flex-col items-center">
            ...
            <p className="text-lg sm:text-xl text-gray-500 max-w-2xl mx-auto font-light leading-relaxed">Trusted by customers who want stronger, thicker, healthier hair — backed by nature and knowledge.</p>
          </div>
        ...
        <div className="relative w-full max-w-6xl rounded-[3rem] overflow-hidden bg-gray-900 border border-gray-800 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] group">
          ...
          <div className="relative z-10 px-6 py-20 sm:p-24 text-center">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-7xl font-black mb-6 text-white tracking-tight">
              Ready to shop <span className="text-transparent bg-clip-text bg-gradient-to-br from-blue-300 via-white to-blue-200">smarter?</span>
            </h2>
            <p className="text-lg md:text-xl text-gray-400 mb-12 leading-relaxed max-w-2xl mx-auto font-light">
              Browse our curated collection of lip glosses, lip liners, lip care, lashes, hair clips and makeup bags. Elevate your everyday.
            </p>
